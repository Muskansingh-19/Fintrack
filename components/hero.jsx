      ...
      <div className="container mx-auto text-center">
        ...
        >
          {/* Finnovate <span className="text-[#1E3A8A]">AI</span> */}
           FinTrak <span className="text-[#4a6cb3]">AI</span>
        </motion.h1>
        <motion.h1
        ...
        >
          FinTrak AI transforms the way you manage finances — with personalized insights,
        ...
        >
          ...
          <Link href="https://www.youtube.com/@vishwasjeet8407">
            <Button
              size="lg"
              variant="outline"
